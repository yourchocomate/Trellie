                    ...
                    >
                        ...
                        <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                            <div className="flex-shrink-0 flex items-center flex-row px-4">
                                <img
                                    ...
                                    alt="Trellie"
                                />
                                <span className="text-xl text-[#fff] font-bold ml-2">Trellie</span>
                            </div>
                        ...
                        <div className="flex-shrink-0 flex bg-gray-700 p-4">
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="text-xs font-medium text-gray-300 group-hover:text-gray-200" onClick={() => auth.logout().then(() => navigate('/'))}>Logout</p>
                                </div>
                            </div>
                            </a>
                        </div>
